...
*/
  ...
  public void setMatrix(double[] m)
    ...
    VisADCanvasA3D canvas =
      ((DisplayRendererA3D) getDisplayRenderer()).getCanvas();
    ...
    ((DisplayRendererA3D) getDisplayRenderer()).setTransform3D(Matrix);
  ...
  private Transform3D init() {
    ...
    Transform3D t1 = new Transform3D(
      visad.java3d.MouseBehaviorJ3D.static_make_matrix(0.0, 0.0, 0.0, scale, 0.0, 0.0, 0.0) );
    mat.mul(t1);
    return mat;
  }
