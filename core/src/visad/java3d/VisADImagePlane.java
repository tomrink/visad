...
public class VisADImagePlane implements ImageComponent2D.Updater {
   ...
   public VisADImagePlane(int numImages, int height, int yStart, int width, int xStart, int depth, int zStart) {
